...
<head>
    ...
    <style>
        ...
        @layer utilities {
            ...
            .transketerlambatan-y-0 {
                --tw-transketerlambatan-y: calc(var(--spacing) * 0);
                transketerlambatan: var(--tw-transketerlambatan-x) var(--tw-transketerlambatan-y)
            }
            ...
            .md\:grid-cols-3 {
                grid-tempketerlambatan-columns: repeat(3, minmax(0, 1fr))
            }
            ...
            .lg\:grid-cols-2 {
                grid-tempketerlambatan-columns: repeat(2, minmax(0, 1fr))
            }
            ...
            .starting\:transketerlambatan-y-4 {
                --tw-transketerlambatan-y: calc(var(--spacing) * 4);
                transketerlambatan: var(--tw-transketerlambatan-x) var(--tw-transketerlambatan-y)
            }
        }@starting-style {
            .starting\:transketerlambatan-y-6 {
                --tw-transketerlambatan-y: calc(var(--spacing) * 6);
                transketerlambatan: var(--tw-transketerlambatan-x) var(--tw-transketerlambatan-y)
            }
        }@starting-style {
            .starting\:opacity-0 {
        ...
        @property --tw-transketerlambatan-x {
            syntax: "*";
            inherits: false;
            initial-value: 0
        }

        @property --tw-transketerlambatan-y {
            syntax: "*";
            inherits: false;
            initial-value: 0
        }

        @property --tw-transketerlambatan-z {
            syntax: "*";
            inherits: false;
            initial-value: 0
        }
...
<div
    ...
    <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row">
        ...
        <div
            ...
            {{-- Laravel Logo --}}
            <svg
                class="w-full text-[#F53003] dark:text-[#F61500] transition-all transketerlambatan-y-0 opacity-100 max-w-none duration-750 starting:opacity-0 starting:transketerlambatan-y-6"
            ...
            <svg class="w-[448px] max-w-none relative -mt-[4.9rem] -ms-8 lg:ms-0 lg:-mt-[6.6rem] dark:hidden"
                ...
                <g class="transition-all delay-300 transketerlambatan-y-0 opacity-100 duration-750 starting:opacity-0 starting:transketerlambatan-y-4">
                    <path
                ...
                <g style="mix-blend-mode: hard-light"
                   class="transition-all delay-300 transketerlambatan-y-0 opacity-100 duration-750 starting:opacity-0 starting:transketerlambatan-y-4">
                    <path
